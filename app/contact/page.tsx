...
const ServicesPage = () => {
  ...
  return (
    <Box>
      ...
      >
        <Box
          className='flex flex-col space-y-3 xs:gap-y-3 sm:gap-y-6 md:gap-y-9'
          sx={{
            border: isMobile ? '1px solid #000000' : 'none',
        ...
        >
          ...
          {isMobile ? (
            ...
            <Box className='px-12 py-12' style={{ paddingBottom: '0px', marginBottom: '30px' }}>
              <Box
          ...
          {isMobile ? (
            <Box className='flex w-full flex-col px-3'>
              <Typography
                variant='h3'
          ...
          {isMobile ? (
            <Box
              className='flex w-full flex-col px-3 gap-y-5'
            ...
            >
              <Box className='flex w-full justify-between'>
                <Box className='w-1/2'>
                  ...
                  >
                    Whether you're embarking on a grand renovation or seeking a touch of elegance
                    for a specific space, our exquisite stone collection and exceptional design
                    expertise are here to help.
                  </Typography>
                </Box>
                <Box className='w-1/2'>
                  <Typography
                  ...
                  >
                    We invite you to connect with our friendly and knowledgeable team to discuss
                    your project and transform your vision into reality.
                  </Typography>
                </Box>
              </Box>
              ...
              <Box className='w-full'>
                ...
                >
                  Our dedicated team is passionate about natural stone and its potential to elevate
                  your space. They're eager to discuss your project's specific needs and guide you
                  through our extensive selection of stone cladding, walling, and paving options.
                </Typography>
              </Box>
            </Box>
          ) : (
            <Box className='flex w-full justify-between px-12'>
              <Box className='w-1/4'>
                <Typography
                  variant='h3'
                  color='white'
                ...
                >
                  Whether you're embarking on a grand renovation or seeking a touch of elegance for
                  a specific space, our exquisite stone collection and exceptional design expertise
                  are here to help.
                </Typography>
              </Box>
              <Box className='w-1/4'>
              ...
              <Box className='w-1/4'>
                ...
                >
                  We invite you to connect with our friendly and knowledgeable team to discuss your
                  project and transform your vision into reality.
                </Typography>
              </Box>
        ...
        {isMobile ? (
          <Box
            className='flex w-full flex-col px-4 gap-y-3'
            sx={{ border: isMobile ? '1px solid #000000' : 'none' }}
          >
            ...
            <Box className='flex w-full justify-between h-full gap-3'>
              ...
              <Box
                className='h-[413px] min-w-[127px] flex justify-center rounded-[20px]'
                sx={{
                  backgroundImage: 'url(/images/Contact/image5.png)',
          ...
          <Box className='flex w-full flex-col gap-y-3 px-12'>
          ...
          >
            ...
            <Box className='flex w-full flex-col gap-y-5'>
              <Box className='flex w-full flex-col justify-center items-center gap-y-4'>
                <Box className='w-1/7'>
                  <Image src='/images/Contact/phone.svg' alt='phone' width={50} height={50} />
                </Box>
                <Box>
                  <Typography
                    variant='h4'
              ...
              <Box className='flex w-full flex-col justify-center items-center gap-y-4'>
                <Box className='w-1/7'>
                  <Image src='/images/Contact/email.svg' alt='email' width={50} height={50} />
                </Box>
                <Box>
                  <Typography
                    variant='h4'
              ...
              <Box className='flex w-full flex-col justify-center items-center gap-y-4'>
                <Box className='w-1/7'>
                  <Image src='/images/Contact/location.svg' alt='location' width={50} height={50} />
                </Box>
                <Box>
                  <Typography
                    variant='h4'
          ...
          >
              ...
              <Box className='flex flex-col w-1/4 gap-y-2'>
                ...
                <ul style={{ listStyleType: 'disc', paddingLeft: '20px', color: 'black' }}>
                  <li>
                    ...
                    >
                      Feel free to browse our website for further information on our products and
                      services.
                    </Typography>
                  </li>
                  <li>
                    ...
                    >
                      For project inspiration, explore our gallery showcasing a variety of stunning
                      stone applications.
                    </Typography>
                  </li>
                </ul>
            ...
            <Box className='flex w-full justify-between'>
              <Box className='flex w-7/12 items-center gap-3'>
                <Box className='w-1/7'>
                  <Image src='/images/Contact/phone.svg' alt='phone' width={40} height={40} />
                </Box>
                <Typography
                  variant='h4'
                  color='#283C28'
            ...
            <Box className='flex w-full justify-between'>
              <Box className='flex w-7/12 items-center gap-3'>
                <Box className='w-1/7'>
                  <Image src='/images/Contact/email.svg' alt='phone' width={40} height={40} />
                </Box>
                <Typography
                  variant='h4'
                  color='#283C28'
            ...
            <Box className='flex w-full justify-between'>
              <Box className='flex w-9/12 items-center gap-3'>
                <Box className='w-1/7'>
                  <Image src='/images/Contact/location.svg' alt='phone' width={40} height={40} />
                </Box>
                <Typography
                  variant='h4'
                  color='#283C28'
                ...
                >
                  ...
                  <span style={{ fontWeight: 300 }}>
                    10/21 COOK RD,MITCHAM, MELBOURNE, VIC 3132.
                  </span>
                </Typography>
              </Box>
              <Box className='flex w-3/12'>

...
const Home = () => {
    ...
    return (
        ...
        >
            ...
            </Box>) : (<Box className="flex flex-col w-full mb-6 sm:flex-row md:flex-row lg:flex-row md:px-[5vw]" sx={{ height: '8vh' }}>
                <Box className="flex items-center w-full sm:w-1/3 md:w-2/5">
                    <Box><WhiteCustomButton label={'Enquire now!'} iconSrc={'images/Vector.svg'} /></Box>
                    <Link href={'/contact'} className="ml-[2.5vw]"><WhiteCustomButton label={'Contact Us'} iconSrc={'images/Vector.svg'} /></Link>
                </Box>

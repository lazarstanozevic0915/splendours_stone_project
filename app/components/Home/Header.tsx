    ...
    <Box className='flex items-center justify-between w-full h-full px-[4vw]'>
      <Box className='flex w-1/2 md:w-1/3 lg:w-1/3'>
        <Box>
          <Link href={'/'}>
            ...
            <Image
              src={
                isMobile ? '/images/Header/mobile-main-logo.png' : '/images/Header/main-logo.svg'
              }
              alt='Logo'
      ...
      {isMobile && (
        <Box className='flex items-center justify-center gap-x-2'>
          ...
          <Box className='block lg:hidden' onClick={handleMenuToggle} sx={{ cursor: 'pointer' }}>
            <Box className='flex items-center justify-center'>
              <Box
                className='relative'
                sx={{
      ...
      {isMobile ? (
        ...
        <Box
          className={`flex justify-between mr-[1.5vw] w-4/5 ${

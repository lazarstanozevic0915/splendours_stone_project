...
const HomePage = () => {
    ...
    return (
        ...
        >
            ...
            {isMobile ? <Box className="flex flex-col w-full items-center justify-center">
                ...
                <Typography variant="body1" color="white" sx={{ fontFamily: "Chronicle Display", fontSize: { xs: '20px', sm: '5vw' }, fontWeight: 700, lineHeight: 1.1, opacity: '10%' }}>SAME DAY QUOTES</Typography>
                <Typography variant="body1" color="#DBC6BC" sx={{ fontFamily: "Chronicle Display", fontSize: { xs: '20px', sm: '5vw' }, fontWeight: 700, lineHeight: 1.1, textAlign: 'center' }}>STATE OF THE ART SHOWROOM</Typography>
                <Typography variant="body1" color="white" sx={{ fontFamily: "Chronicle Display", fontSize: { xs: '20px', sm: '5vw' }, fontWeight: 700, lineHeight: 1.1, opacity: '10%', textAlign: "right" }}>SUPPLY & INSTALL PACKAGES</Typography>
            </Box>}
            ...
            <Box className="space-y-24 w-full" sx={{ paddingX: isMobile ? 2 : 8 }}>
                <Box className="w-full" sx={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', justifyContent: isMobile ? 'center' : 'space-between', alignItems: isMobile ? 'center' : 'flex-start', paddingX: isMobile ? 0 : 2 }}>

                    {isMobile ? <Box className="py-4" sx={{ width: isMobile ? "80%" : "70%" }} >
                        <Typography
                            variant="h3"
                            color="#DBC6BC"
                            className="text-center"
                    ...
                    {isMobile ? <Box className="flex flex-col items-center w-full pt-3 space-y-7">
                    ...
                    </Box> : <Box className="flex flex-col justify-start w-1/4 gap-y-5 mt-5">
                        <Box >
                            <Typography
                                variant="h3"
                                color="#ffffff"
                ...
                {isMobile ? <StairsCarousel images={images} /> : <Box className="w-full flex flex-col aspect-[3.77/1] min-w-1 bg-[#DBC6BC] rounded-[40px] p-8 px-12" style={{ marginTop: '230px' }}>
